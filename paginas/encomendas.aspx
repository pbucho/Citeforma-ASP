...
<asp:Content ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    ...
    <div>
        <asp:Label ID="lb_nif_cliente" runat="server" Text="Label">NIF do cliente:</asp:Label>&nbsp;<asp:TextBox ID="tx_nif_pesquisa" runat="server"></asp:TextBox>
        <br />
        <br />
        ...
        <br />
        <b>
            <asp:Label ID="lb_editar_encomendas_login" runat="server">A pesquisa pode ser feita pelo NIF do cliente, data de encomenda, ou ambos.</asp:Label></b>
        <br />
        <asp:GridView ID="gv_resultadoPesquisa" runat="server" AllowPaging="True" AllowSorting="True" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" AutoGenerateDeleteButton="True" AutoGenerateSelectButton="True" OnPageIndexChanging="gv_resultadoPesquisa_PageIndexChanged">
        ...
        <table class="auto-style1">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="tx_data" runat="server"></asp:TextBox>
                </td>
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="tx_data" ErrorMessage="Obrigatório"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
